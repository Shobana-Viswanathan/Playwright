...
- Location: tests\testskipprac.test.ts:3:1
      ...
      - generic [ref=e4]:
        ...
        - generic [ref=e9]:
          - generic [ref=e10]:
            ...
            - textbox [ref=e12]: Shobs
          - generic [ref=e13]:
            - generic [ref=e14]: "Password:"
            - textbox [ref=e15]: shobi11
        - generic [ref=e17]:
...
```ts
  ...
  8  |     await page.fill('#loginusername', "Shobs");
  9  |     await page.fill('#loginpassword', "shobi11");
  10 |     await page.click('button[onclick="logIn()"]');
  11 | 
  12 |     const welcometxt = await page.locator("#nameofuser").textContent();
  13 | 
> 14 |     await expect.soft(welcometxt).toBe('Welcome Shobs');
     |                                   ^ Error: expect(received).toBe(expected) // Object.is equality
  15 | 
  16 | });
  17 | 
  ...
  19 | 
  20 |     test.skip(true, "Under maintenance");
  21 | 
  22 |     await page.goto("https://www.demoblaze.com/");
  23 | 
  24 |     await page.click('#login2');
  25 |     await page.fill('#loginusername', "Shobs");
  26 |     await page.fill('#loginpassword', "shobi11");
  27 |     await page.click('button[onclick="logIn()"]');
  28 | 
  29 |     await expect(
  30 |         page.getByRole("link", { name: "Log out" })
  31 |     ).toBeVisible();
  32 | 
  33 |     const welcometxt = await page.locator("#nameofuser").textContent();
  34 | 
  35 |     expect(welcometxt).toBe('Welcome Shobs');
  36 | 
  37 | });
```