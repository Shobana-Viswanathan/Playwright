...
- Name: registeruserexist.test.ts >> Registeruser Exist
- Location: tests\registeruserexist.test.ts:2:1
...
- text: Email
- superscript: "*"
- textbox "Email *" [disabled]: demo567user@gmail.com
- text: Password
- superscript: "*"
- textbox "Password *"
- text: Date of Birth
...
```ts
  ...
  2 | test('Registeruser Exist',async({page})=>{
  ...
  6 |    await page.locator('//input[@data-qa="signup-email"]').fill("demo567user@gmail.com");
  7 |    await page.locator('//button[@data-qa="signup-button"]').click();
> 8 |    await expect(page.locator('//p[text()="Email Address already exist!"]')).toBeVisible();
    |                                                                             ^ Error: expect(locator).toBeVisible() failed
  9 | })
```