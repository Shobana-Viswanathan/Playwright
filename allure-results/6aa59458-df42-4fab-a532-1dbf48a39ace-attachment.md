...
- Name: testcasespage.test.ts >> Verify test case page visible
- Location: tests\testcasespage.test.ts:2:1
...
Expected: "http://automationexercise.com/"
Received: "https://automationexercise.com/"
Timeout:  5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    11 × unexpected value "https://automationexercise.com/"
...
- paragraph:
  ...
  - link "API testing documentation":
    - img
...
- insertion:
  - iframe
- img
- link "Go to shopping options for Test case management": Test case management
...
```ts
  ...
  2 | test('Verify test case page visible',async({page})=>{
  3 |     await page.goto('https://automationexercise.com/');
> 4 |     await expect(page).toHaveURL('http://automationexercise.com/');
    |                        ^ Error: expect(page).toHaveURL(expected) failed
  5 |     await page.locator('//a[contains(text(),"Test Cases")]').click();
  6 |     await expect(page).toHaveURL('https://automationexercise.com/test_cases');
  7 | })
```